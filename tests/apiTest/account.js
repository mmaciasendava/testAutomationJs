...
describe('Create a new board in Trello', function () {
    var _this = this;
    it('Create a new board and verify it', function () { return __awaiter(_this, void 0, void 0, function () {
        var board, newBoard, boards, result, deleteBoard;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    board = new board_1.Board();
                    return [4 /*yield*/, board.newBoard('work from home')];
                case 1:
                    newBoard = _a.sent();
                    ...
                    return [4 /*yield*/, board.searchBoards()];
                case 2:
                    boards = _a.sent();
                    result = boards.filter(function (item) {
                        return item.id == idNew;
                    });
                    expect(result[0].id).to.equal(idNew);
                    console.log("Delete the board created");
                    return [4 /*yield*/, board.deleteBoard(newBoard.id)];
                case 3:
                    deleteBoard = _a.sent();
